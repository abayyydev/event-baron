...
if (!isset($_GET['event_id'])) {
    echo "<script>window.location='data_pendaftar.php';</script>";
    exit();
}
...
try {
    ...
    if (!$event) {
        echo "<div class='min-h-screen flex items-center justify-center bg-gray-50'><div class='text-center'><h2 class='text-xl font-bold text-gray-800'>Event tidak ditemukan atau akses ditolak.</h2><a href='data_pendaftar.php' class='text-emerald-600 mt-4 block'>Kembali</a></div></div>";
        exit();
    }
        ...
        <div class="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
                <div class="flex items-center gap-3 mb-3">
                    <a href="data_pendaftar.php" class="text-emerald-200 hover:text-white transition-all bg-white/10 hover:bg-white/20 p-2 rounded-full backdrop-blur-sm group">
