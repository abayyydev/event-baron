...
<div class="container mx-auto px-4 py-8 md:py-12 max-w-6xl">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-2/3">
            ...
            <div
                class="bg-gradient-to-r from-green-700 to-green-900 rounded-2xl shadow-xl overflow-hidden mb-8 relative">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between">
                        <div class="mb-4 md:mb-0">
                            ...
                            <p class="text-green-100 text-lg">
                                ...
                                <?= date('H:i', strtotime($workshop['tanggal_waktu'])) ?> WIB
                            </p>
                        </div>
                ...
                <div class="p-6">
                    ...
                    <form action="proses_daftar.php?id=<?= $workshop_id ?>" method="POST">
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_peserta" id="nama"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2 flex space-x-4">
                                <label class="flex items-center"><input type="radio" class="form-radio text-green-600"
                        ...
                        <button type="submit"
                            class="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-semibold py-4 px-6 rounded-lg transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center">
